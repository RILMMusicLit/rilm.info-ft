...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <pattern id="structure.checks">
        ...
        <rule role="error" context="tei:surname|tei:forename">
            <assert test="count(tei:nameLink) = 0"> nameLink should not be a child of surname or
                forename. </assert>
        </rule>
        <rule context="tei:div|tei:bibl">
    ...
    <pattern id="reference.checks">
        ...
        <rule context="tei:bibl">
            ...
            <report role="error" test="ancestor::tei:list and tei:date">
                ...
                Dates in bibliographic references should be tagged as biblScope. </report>
        </rule>
        ...
        <rule context="bibl">
            <report role="warning" test="matches(.,'^[p|S]\.\s?\d+$')">
                ...
                The citation may include a stray page reference. </report>
        </rule>
        ...
        <rule context="tei:title[@type='collection']">
            <report role="error"
                test="following-sibling::tei:biblScope[@unit='sd']"> This
                is either a periodical, or should not have a biblScope/@unit='sd'. </report>
        </rule>
        <rule context="tei:title[@type='collection']">
            <report role="error"
                test="following-sibling::tei:biblScope[@unit='issue']"> This
                is a periodical, not a collection. </report>
        </rule><rule abstract="true" id="editedvol">
            <assert role="warning"
